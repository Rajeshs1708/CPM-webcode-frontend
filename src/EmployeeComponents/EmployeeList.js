...
const EmployeeList = () => {
    ...
    const getEmployees = () => {
        axios.get(`${process.env.REACT_APP_BASE_URL}/get-all-employee`).then(response => {
    ...
    const deleteEmployee = (employeeId) => {
        axios.delete(`${process.env.REACT_APP_BASE_URL}/delete-employee/${employeeId}`).then(response => {
            if (response) {
                getEmployees();
            }
        }).catch(err => {
