...
const UpdateEmployee = () => {
    ...
    useEffect(() => {
        ...
        axios.get(`${process.env.REACT_APP_BASE_URL}/get-single-employees/${id}`).then(response => {
    ...
    const handleSubmit = async (e) => {
        ...
        try{
            const response = await axios.put(`${process.env.REACT_APP_BASE_URL}/update-employee/${id}`, newEmployee);
            if(response){
                setEmployeeDetails({
                    name: "",
                    email: "",
